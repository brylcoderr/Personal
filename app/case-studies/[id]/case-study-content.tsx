          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <FadeInUp className="space-y-8 md:space-y-10 min-w-0 overflow-hidden">
              <div className="space-y-4 md:space-y-6">
                ...
                <p className="text-lg md:text-2xl text-black/80 font-black uppercase tracking-tight">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12">
                {study.metrics.map((metric, i) => (
                    <div key={i} className="bg-white neo-border p-4 md:p-8 neo-shadow-sm rotate-1 hover:rotate-0 transition-transform">
                        ...
                        <p className="text-[10px] md:text-xs font-black uppercase tracking-widest text-black/80 leading-tight">{metric.label}</p>
                    </div>
                ))}
            </div>
        </div>
