    ...
    <main className="min-h-screen bg-[#F1E9DA]">
      ...
      <section className="pt-44 pb-32">
        <div className="section-container text-center mb-24">
          <span className="text-[13px] font-semibold uppercase tracking-[0.14em] text-[#541388] mb-4 block">Meet BrylCodes</span>
          <h1 className="text-5xl md:text-[80px] font-black text-[#2E294E] leading-tight mb-8">
            Built for <span className="text-[#541388]">Visionary</span> Founders
          </h1>
          <p className="text-xl text-[#2E294E]/70 max-w-2xl mx-auto font-medium leading-relaxed">
            We are a full-stack engineering studio dedicated to helping ambitious companies scale through high-performance software systems.
          </p>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <FadeInUp>
              ...
              <div className="space-y-12">
                {[
                  { icon: Layers, title: 'Ownership Mindset', desc: 'We take full responsibility for the architectural integrity and success of your digital ecosystem.' },
                  { icon: ShieldCheck, title: 'Resilience by Design', desc: 'We build systems that are secure, auditable, and prepared for high-volume enterprise production.' },
                  { icon: BarChart3, title: 'Metric-Driven Growth', desc: 'Every line of code is written with business performance and conversion in mind.' }
                ].map((item, i) => (
            ...
            <div className="relative aspect-square">
              ...
              <div className="absolute inset-0 bg-[#541388] rounded-[4rem] rotate-3 flex items-center justify-center p-20 shadow-2xl overflow-hidden">
                 <Globe className="w-full h-full animate-spin-slow opacity-20 text-[#FFD400]" />
              </div>
            </div>
          </div>
        </div>
