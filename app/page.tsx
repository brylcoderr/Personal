          ...
          <svg viewBox="0 0 200 200" className="w-full h-full fill-black font-black uppercase text-[15px] tracking-[0.2em]">
            ...
            <text>
              <textPath href="#textPath" startOffset="0%">
                BRYLCODES • AI   • AUTOMATION • BRYLCODES • AI   • AUTOMATION •
              </textPath>
            </text>
          </svg>
        ...
        <div className="max-w-4xl space-y-6 md:space-y-8">
          <FadeInUp>
            <div className="flex items-center gap-4 mb-6 md:mb-8">
              <SectionEyebrow className="mb-0 text-[10px] md:text-xs">BRYLCODES ★ AI DEVELOPMENT  </SectionEyebrow>
      ...
      <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
        ...
        <FadeInUp className="space-y-6 md:space-y-8">
            ...
            {[
              ...
              <div key={i} className="flex gap-4 md:gap-6 items-start group">
                ...
                <div className="flex flex-col md:flex-row md:items-baseline gap-1 md:gap-4">
                  ...
                  <span className="text-black/80 font-bold text-xs md:text-base uppercase tracking-tight leading-tight group-hover:text-black transition-colors">{item.detail}</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <Link href="/about" className="neo-btn bg-black text-white inline-flex items-center gap-4 group shadow-[4px_4px_0px_#FFD93D] w-full md:w-auto justify-center py-4 md:py-5">
            ABOUT THE   <MoveRight className="group-hover:translate-x-2 transition-transform w-5 h-5 md:w-6 md:h-6" strokeWidth={4} />
          </Link>
        </FadeInUp>
      </div>
    </div>
              ...
              <div className="neo-card bg-white group overflow-hidden">
                ...
                <div className="p-6 md:p-10 flex flex-col h-full">
                  <div className="flex items-center gap-3 mb-4 md:mb-6">
                    ...
                    <span className="text-[8px] md:text-[9px] font-black uppercase tracking-widest text-black/80">V2.4.0</span>
                  </div>
        ...
        {[
          ...
          },
          {
            ...
            skills: [
              ...
              { name: 'Terminal', icon: '/icons/console.png' },
          ...
          },
          {
            ...
            skills: [
              { name: 'Load Balancing', icon: '/icons/load-balancer.png' },
              { name: 'Optimization', icon: '/icons/optimization.png' },
              { name: 'Monitoring', icon: '/icons/activity.png' },
              { name: 'Caching', icon: '/icons/layers.png' },
              { name: 'Security', icon: '/icons/cyber-security.png' }
            ]
          },
          {
            category: 'DEVOPS',
            skills: [
              ...
              { name: 'Databases', icon: '/icons/database.png' }
            ]
          }
        ].map((item, i) => (
