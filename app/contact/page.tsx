              ...
              <div className="space-y-8 md:space-y-12">
                ...
                <div className="pt-8 md:pt-12 border-t-4 border-black">
                  ...
                  <div className="flex flex-wrap gap-4 md:gap-10">
                    <Link href="https://linkedin.com/in/brylcoder" aria-label="LinkedIn" className="text-black hover:text-neo-accent p-3 md:p-4 neo-border bg-white neo-shadow-sm hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all"><Linkedin className="w-6 h-6 md:w-8 md:h-8" strokeWidth={3} /></Link>
                    <Link href="https://twitter.com/brylcodes" aria-label="Twitter" className="text-black hover:text-neo-accent p-3 md:p-4 neo-border bg-white neo-shadow-sm hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all"><Twitter className="w-6 h-6 md:w-8 md:h-8" strokeWidth={3} /></Link>
                    <Link href="https://github.com/brylcoderr" aria-label="GitHub" className="text-black hover:text-neo-accent p-3 md:p-4 neo-border bg-white neo-shadow-sm hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all"><Github className="w-6 h-6 md:w-8 md:h-8" strokeWidth={3} /></Link>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4">
                  {[
                    ...
                    <div key={i} className="p-3 md:p-4 bg-white neo-border text-center">
                      ...
                      <span className="text-[8px] md:text-[10px] font-black uppercase tracking-widest text-black/80">{s.label}</span>
                    </div>
                  ))}
                </div>
                <p className="text-xs md:text-sm text-black/80 font-bold uppercase tracking-tight mt-4 italic">
